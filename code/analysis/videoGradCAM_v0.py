 ...
 * @modify date 2021-11-08 23:44:33
 * @desc [description]
 """
...
class GradCam:
    ...
    def __init__(self, model, model_name, feature_module, target_layer_names):
        self.model = model
        self.model_name = model_name
        self.feature_module = feature_module
...
class VideoGradCAM(object):
    ...
    def __init__(self, model, feature_module, target_layer_names, target_category = None):
        
        # If None, returns the map for the highest scoring category.
        # Otherwise, targets the requested category.
        self.target_category = target_category

        self.grad_cam = GradCam(model, '', feature_module, target_layer_names)

        self.gb_model = GuidedBackpropReLUModel(model)
