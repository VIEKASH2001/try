...
def readVideosToProcess(rootDir):
    ...
    videoFiles =  [
    # "122/122(07.09.21)L1-C19-cardiac.avi", #Right - x_low, y_low, x_high, y_high = (642, 84, 675, 112)
    # "122/122(07.09.21)R1-C19-cardiac.avi", #Right - x_low, y_low, x_high, y_high = (642, 84, 675, 112)
    # "134/134(07.14.21)L1-C19-lung.avi", #Left - x_low, y_low, x_high, y_high = (397, 110, 426, 139)
    # "134/134(07.14.21)R1-C19-lung.avi", #Left - x_low, y_low, x_high, y_high = (397, 110, 426, 139)
    # "137/137(07.31.21)R1-C19-cardiac.avi", #Right - x_low, y_low, x_high, y_high = (625, 71, 655, 99)
    # "137/137(07.31.21)L1-C19-cardiac.avi", #Right - x_low, y_low, x_high, y_high = (625, 71, 655, 99) 
    # "148/148(08.16.21)L1-C19-lung.avi", #Right - x_low, y_low, x_high, y_high = (625, 71, 655, 99) 
    "148/148(08.16.21)R1-C19-lung.avi" #Right - x_low, y_low, x_high, y_high = (625, 71, 655, 99) 
    ]
...
def cropConvexVideos(rootDir):
    ...
    for video in videoFiles:
        ...
        x_low, y_low, x_high, y_high = (625, 71, 655, 99)
        ...
        # x_low, y_low, x_high, y_high = (397, 110, 426, 139)
        processed_framesList[:, y_low:y_high+1, x_low:x_high+1] = 0
