...
def fitMLmodels(train_label_ft, test_label_ft, gt_train_scores, gt_test_scores, train_video_list, test_video_list, train_folds, test_folds,
                    ...
                    gt_label_dict, label_dict_path, BiomarkerModel, onlyEnd2End, UsePerPatientFeatures):
...
def fitTaskMLmodels(task, dataset_split_dict, train_folds, test_folds, train_label_dict, test_label_dict, gt_label_dict, label_features, 
        ...
        UsePerPatientFeatures, video_to_patient_wise_info_mapping_dict):
...
def fitFoldMLmodels(train_folds, test_folds, exp_path, exp_name, prefix, dataset_split_dict_path, dataset_split_dict,
            ...
            UsePerPatientFeatures, patient_wise_info_dict, video_to_patient_wise_info_mapping_dict, consolidated_patient_info_dict, consolidation_type):
    ...
    if UsePerPatientFeatures:
        ...
        train_label_dict = featureConsolidation(train_label_dict, video_to_patient_wise_info_mapping_dict, consolidation_type)
        test_label_dict = featureConsolidation(test_label_dict, video_to_patient_wise_info_mapping_dict, consolidation_type)
        gt_label_dict = featureConsolidation(gt_label_dict, video_to_patient_wise_info_mapping_dict, consolidation_type, ignore_missing = True)
...
if __name__ == '__main__':
    ...
    consolidation_type = "mean" #"max", "mean", "concat"
