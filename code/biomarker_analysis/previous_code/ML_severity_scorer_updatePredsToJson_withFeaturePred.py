...
def decisonTreePostAnalysis(clf, ml_predictions, accuracy, train_label_ft, test_label_ft, gt_train_scores, gt_test_scores, train_video_list, test_video_list, \
    exp_name, task, reports_path, label_names, lung_severity_scores, test_label_dict, plotDecisionTree = False, BiomarkerModel = True):
...
def fitMLmodels(train_label_ft, test_label_ft, gt_train_scores, gt_test_scores, train_video_list, test_video_list, train_folds, test_folds,
                    exp_name, task, reports_path, label_names, lung_severity_scores, test_label_dict, BiomarkerModel):
...
if __name__ == '__main__':
    ...
    reports_path = os.path.join(exp_path, exp_name, "reports")
    ...
    train_label_dict, test_label_dict = getTrainAndTestFeatures(dataset_split_dict_path, exp_path, exp_name, label_dict_path, train_folds, test_folds, 
                multi_task = MULTI_TASK, use_probs = useProbs, BiomarkerModel = BiomarkerModel)
    ...
    fitMLmodels(train_label_ft, test_label_ft, gt_train_scores, gt_test_scores, train_video_list, test_video_list, train_folds, test_folds,
                    exp_name, task, reports_path, label_names, lung_severity_scores, test_label_dict, BiomarkerModel)
