...
from model.video_models.basic_ops import ConsensusModule
...
class TSN(nn.Module):
    def __init__(self, num_class, num_segments, modality,
                ...
                #  is_shift=False, shift_div=8, shift_place='blockres', fc_lr5=False,
                 ...
                 temporal_pool=False, non_local=False, featureConcensus = False):
        ...
        self.featureConcensus = featureConcensus
        print(f"TSM featureConcensus = {self.featureConcensus}")
    ...
    def forward(self, input, no_reshape=False):
        ...
        if self.featureConcensus:
            base_out = base_out.view((-1, self.num_segments) + base_out.size()[1:])
            base_out = F.adaptive_max_pool1d(base_out.permute(0,2,1), 1).squeeze()
