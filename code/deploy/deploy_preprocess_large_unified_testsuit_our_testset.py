 ...
 * @modify date 2022-01-26 21:43:53
 * @desc [description]
 """
...
class TSN(nn.Module):
    ...
    def preprocess_input_using_corner_pts(self, video_frames, left_upper_point, left_lower_point, right_upper_point, right_lower_point):
    ...
    def forward(self, input, left_upper_point, left_lower_point, right_upper_point, right_lower_point, no_reshape:bool = False):
        #Preprocess input
        input = self.preprocess_input_using_corner_pts(input, left_upper_point, left_lower_point, right_upper_point, right_lower_point)
...
if __name__ == "__main__":
    ...
    testsuit_videos = [
        ["NoSliding/image_4641643404894_CLEAN.mp4", "NoSliding"],
        ["NoSliding/image_1087766719219_clean.mp4", "NoSliding"],
        ["NoSliding/image_634125159704_CLEAN.mp4", "NoSliding"],
        ["NoSliding/image_642169070951_clean.mp4", "NoSliding"],
        ["NoSliding/image_1083297968960_clean.mp4", "NoSliding"],
        ["NoSliding/image_1895283541879_clean.mov", "NoSliding"],
        ["NoSliding/image_1884162273498_clean.mov", "NoSliding"],
        ["NoSliding/image_603665940081_clean.mov", "NoSliding"],
        ["NoSliding/image_614587120545_clean.mov", "NoSliding"],

        ["Sliding/image_104543812690743_CLEAN.mov", "Sliding"],
        ["Sliding/image_104548309385533_CLEAN.mov", "Sliding"],
        ["Sliding/image_104932526155699_CLEAN.mov", "Sliding"],
        ["Sliding/image_10891015221417_clean.mp4", "Sliding"],
        ["Sliding/image_1180496934444_clean.mp4", "Sliding"],
        ["Sliding/image_677741729740_clean.mp4", "Sliding"],
        ["Sliding/image_73815992352100_clean.mp4", "Sliding"],
        ["Sliding/image_74132233134844_clean.mp4", "Sliding"],
        ["Sliding/image_588413346180_CLEAN.mp4", "Sliding"],
        
    ]
    
    # testsuit_videos = [
    #         ["image_2673074007832_CLEAN.mp4",	"Sliding"],
    #         ["image_2518177532892_CLEAN.mp4",	"Sliding"],
    #         ["image_307870966391_CLEAN.mp4",	"Sliding"],
    #         ["image_527803396828_CLEAN.mp4",	"Sliding"],
    #         ["image_2100361349561_CLEAN.mp4",	"Sliding"],
    #         ["image_1991804868665_CLEAN.mp4",	"NoSliding"],
    #         ["image_432792096448_CLEAN.mp4",	"Sliding"],
    #         ["image_2375004178780_CLEAN.mp4",	"NoSliding"],
    #         ["image_225130637841202_CLEAN.mp4",	"Sliding"],
    #         ["image_703682641552_CLEAN.mp4",	"Sliding"],
    #         ["image_1036584980280_CLEAN.mp4",	"Sliding"],
    #         ["image_931984558757_CLEAN.mp4",	"NoSliding"],
    #         ["image_987146487434_CLEAN.mp4",	"Sliding"],
    #         ["image_6692463753591_CLEAN.mp4",	"NoSliding"],
    #         ["image_2475978478013_CLEAN.mp4",	"NoSliding"],
    #         ["image_1355315203127_CLEAN.mp4",	"Sliding"],
    #         ["image_1604910716625_CLEAN.mp4",	"NoSliding"],
    #         ["image_740584633467_CLEAN.mp4",	"Sliding"],
    #         ["image_2370853937896_CLEAN.mp4",	"Sliding"],
    #         ["image_4065361175427_CLEAN.mp4",	"Sliding"],
    #         ["image_1675609772328_CLEAN.mp4",	"Sliding"],
    #         ["image_1710325448148_CLEAN.mp4",	"Sliding"],
    #         ["image_1447186382728_CLEAN.mp4",	"Sliding"],
    #         ["image_1215182877868_CLEAN.mp4",	"Sliding"],
    #         ["image_4217982672400_CLEAN.mp4",	"NoSliding"],
    #         ["image_4227031119375_CLEAN.mp4",	"NoSliding"],
    #         ["image_383588065321_CLEAN.mp4",	"Sliding"],
    #         ["image_9970708112236_CLEAN.mp4",	"Sliding"],
    #         ["image_270509486562_CLEAN.mp4",	"NoSliding"],
    #         ["image_706555992698_CLEAN.mp4",	"NoSliding"],
    #         ["image_3012822351141_CLEAN.mp4",	"Sliding"],
    #         ["image_222706744966_CLEAN.mp4",	"Sliding"],
    #         ["image_358997745435_CLEAN.mp4",	"Sliding"],
    #         ["image_2719958257554_CLEAN.mp4",	"Sliding"],
    #         ["image_560395551296_CLEAN.mp4",	"NoSliding"],
    #         ["image_595115042480_CLEAN.mp4",	"NoSliding"],
    #         ["image_620422280751_CLEAN.mp4",	"NoSliding"],
    #         ["image_3512795900742_CLEAN.mp4",	"NoSliding"],
    #         ["image_3945589816827_CLEAN.mp4",	"NoSliding"],
    #         ["image_456885889303_CLEAN.mp4",	"NoSliding"],
    #         ["image_9367839490019_CLEAN.mp4",	"NoSliding"],
    #         ["image_9401889534225_CLEAN.mp4",	"NoSliding"],
    #         ["image_233507706680_CLEAN.mp4",	"NoSliding"],
    #         ["image_507659607045_CLEAN.mp4",	"NoSliding"],
    #         ["image_543109924479_CLEAN.mp4",	"NoSliding"],
    #     ]

    # video_corner_pts_json_path = os.path.join(video_root_path, "video_corner_pts.json")

    # video_corner_pts_dict = {}
    # if os.path.exists(video_corner_pts_json_path):
        
    #     with open(video_corner_pts_json_path, 'r') as json_file:
    #         video_corner_pts_dict = json.load(json_file)
          
    
    no_sliding_video_corner_pts_json_path = os.path.join(video_root_path, "NoSliding", "video_corner_pts.json")
    
    no_sliding_video_corner_pts_dict = {}
    if os.path.exists(no_sliding_video_corner_pts_json_path):
        
        with open(no_sliding_video_corner_pts_json_path, 'r') as json_file:
            no_sliding_video_corner_pts_dict = json.load(json_file)

    sliding_video_corner_pts_json_path = os.path.join(video_root_path, "Sliding", "video_corner_pts.json")

    if os.path.exists(sliding_video_corner_pts_json_path):
        
        with open(sliding_video_corner_pts_json_path, 'r') as json_file:
            sliding_video_corner_pts_dict = json.load(json_file)

    video_corner_pts_dict = no_sliding_video_corner_pts_dict
    for k, v in sliding_video_corner_pts_dict.items():
        video_corner_pts_dict[k] = v
    ...
    for video_name, video_desc in testsuit_videos:
    ...
    #    video_frames = [cv2.resize(f, image_size) for f in video_frames]
        ...
        # video_name_corner = video_name[:-4]
        video_name_corner = video_name[:-4].split("/")[-1]
        left_upper_point, left_lower_point, right_upper_point, right_lower_point = video_corner_pts_dict[video_name_corner]
        ...
        with torch.no_grad():
            ...
            for idx in range(idx_count):
                ...
                # pred = model(clip)
                pred = model(clip, left_upper_point, left_lower_point, right_upper_point, right_lower_point)
