 ...
 * @modify date 2022-01-26 20:20:18
 * @desc [description]
 """
...
if __name__ == "__main__":
    ...
    #    video_frames = [cv2.resize(f, image_size) for f in video_frames]
        ...
        with torch.no_grad():
            ...
            for idx in range(idx_count):
                ...
                # pred, in_clip = model(clip)
                pred, in_clip = model(clip, left_upper_point, left_lower_point, right_upper_point, right_lower_point)
                
                plt.imshow(in_clip[0,0,0].numpy())
                plt.savefig(f"{video_name.split('.')[0].replace('/', '_')}_clip-{idx}.png")
    ...
    if JOHN_SYS:
        ...
        output_names = [ "classLabel", "var_809"] #"var_736"]
